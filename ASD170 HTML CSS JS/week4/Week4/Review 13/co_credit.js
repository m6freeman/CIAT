...
window.addEventListener("load", () => {
  var orderData = decodeURIComponent(window.location.search).slice(1).replace(/[+]/g, " ");
...
function validateCVC() {
  ...
  var creditCard = document.querySelector('input[name="company"]:checked')
    .value;
