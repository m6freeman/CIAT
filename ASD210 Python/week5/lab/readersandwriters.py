...
class Writer(Thread):
    ...
    def run(self):
        ...
        self.cell.write(self.cell.data.increment)
        print("%s is done incrementing to %d" % (self.getName(), self.cell.data.value))
...
class Reader(Thread):
    ...
    def run(self):
        ...
        self.cell.read(self.cell.data.getValue)
        print("%s is done getting %d" % (self.getName(), self.cell.data.value))
